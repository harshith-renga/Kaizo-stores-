      ...
      <div className="min-h-screen bg-dark-bg">
        ...
        <div className="relative w-full h-[50vh] overflow-hidden flex items-end bg-grain border-b border-dark-border">
          ...
          <img
            src={meta.hero}
            alt={meta.title}
            className="absolute inset-0 w-full h-full object-cover opacity-25 scale-102"
          />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 pt-10">
          ...
          {products && products.length > 0 ? (
            <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-24">
